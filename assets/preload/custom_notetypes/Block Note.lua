...
function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'Block Note' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'notes/BLOCKNOTE_assets'); --Change texture
